...
if __name__ == "__main__":
    ...
    policy_network = QModel(obs_space, envs[0].action_space)
    target_network = QModel(obs_space, envs[0].action_space)
    ...
    if args.algo == "a2c":
        ...
        algo = torch_ac.QLearn(envs[0], policy_network, target_network, device, args.max_memory,
